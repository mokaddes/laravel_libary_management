                    ...
                    <div class="row align-items-center no-gutters">
                        <div class="col mr-2">
                            ...
                            <div class="text-dark font-weight-bold h5 mb-0">
                                <span>{{ count(App\Models\User::all()) }}</span>
                            </div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row align-items-center no-gutters">
                        <div class="col mr-2">
                            ...
                            <div class="text-dark font-weight-bold h5 mb-0"><span>{{ count(App\Models\Book::all()) }}</span></div>
                        </div>
        ...
        <div class="col-md-6 col-xl-3 mb-4">
            <div class="card shadow border-left-info py-2">
                <div class="card-body">
                    <div class="row align-items-center no-gutters">
                        <div class="col mr-2">
                            <div class="text-uppercase text-info font-weight-bold text-xs mb-1"><span>Total Rent</span></div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="text-dark font-weight-bold h5 mb-0 mr-3"><span>{{ count(App\Models\Rent::all()) }}</span></div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-md-6 col-xl-3 mb-4">
            <div class="card shadow border-left-warning py-2">
                <div class="card-body">
                    <div class="row align-items-center no-gutters">
                        <div class="col mr-2">
                            <div class="text-uppercase text-info font-weight-bold text-xs mb-1"><span>Return Books</span></div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="text-dark font-weight-bold h5 mb-0 mr-3"><span>{{ DB::table('rents')->where('is_return', 1)->count() }}</span></div>
                                </div>
                                <div class="col">
                                    <div class="progress progress-sm">
                                        <div class="progress-bar bg-info" aria-valuenow="{{ DB::table('rents')->where('is_return', 1)->count() }}" aria-valuemin="0" aria-valuemax="{{ DB::table('rents')->count() }}" style="width: {{ (DB::table('rents')->where('is_return', 1)->count() * 100)/(DB::table('rents')->count()) }}%;">
                                            <span class="sr-only">
                                                {{ (DB::table('rents')->where('is_return', 1)->count() * 100)/(DB::table('rents')->count()) }}
                                            </span>
                                        </div>
                                    </div>
                                </div>
